...
function commitWork(fiber) {
  ...
  if (fiber.effectTag === "PLACEMENT" && fiber.dom != null) {
    ...
    commitDiletion(fiber, domParent);
  }
...
function commitDiletion(fiber, domParent) {
  if (fiber.dom) {
    domParent.removeChild(fiber.dom);
  } else {
    commitDiletion(fiber.child, domParent);
  }
}
...
function updateArrayComponent(fiber) {
...
function reconcileChildren(wipFiber, elements) {
  ...
  elements = elements.reduce((prev, current) => {
